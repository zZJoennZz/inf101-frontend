                ...
                <div className="visits-list-inner">
                    <div className="row">
                        ...
                        <div className="col-8">
                            ...
                            <button className="visits-list-view"><i className="fas fa-folder-open"></i> View</button>
                        </div>
                        <div className="col-2">
                            <button className="visits-list-delete"><i className="fas fa-trash-alt"></i></button>
                            <button className="visits-list-print"><i className="fas fa-print"></i></button>
                        </div>
                    </div>
                </div>
            </div>
