...
const ReportMyTherapyForBodyMiniMat = ({ visitId, reportId, clientId }) => {
  const queryKey = "myTherapyForMiniMat" + visitId + reportId + clientId;
  ...
  return (
    <div className="p-3 overflow-x-auto rounded-lg border border-slate-200">
      <div className={frmMode === 0 ? "hidden" : "block"}>
        ...
        <h1 className="mb-3 text-lg font-bold">myTherapy for Body Mini Mat</h1>
...
export default ReportMyTherapyForBodyMiniMat;
