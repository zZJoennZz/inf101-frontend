...
const ReportMyCommunity = ({ visitId, reportId, clientId }) => {
  const queryKey = "myCommunityReport" + visitId + reportId + clientId;
  ...
  return (
    <div className="p-3 overflow-x-auto rounded-lg border border-slate-200">
      <div className={frmMode === 0 ? "hidden" : "block"}>
        ...
        <h1 className="mb-3 text-lg font-bold">myCommunity</h1>
...
export default ReportMyCommunity;
