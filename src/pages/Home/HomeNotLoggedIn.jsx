...
const HomeNotLoggedIn = ({ runLogin }) => {
      ...
      <div className="row">
        <div className="border border-slate-200 p-4 rounded-lg">
          ...
          <form onSubmit={onSubmitLogin}>
            ...
            <button className="py-2 px-4 hover:bg-cyan-500 hover:border-cyan-500 transition-all ease-in-out bg-cyan-600 text-white border border-cyan-600 rounded-md font-bold shadow-lg hover:shadow-none">
